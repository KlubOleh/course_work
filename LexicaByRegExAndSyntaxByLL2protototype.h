/*
ѕерев≥рки прототипу LL(2)-синтаксичного анал≥затора (спец≥альна структура) та прототипу лексичного анал≥затора (регул€рн≥ вирази) за допомогою коду.
...
#define TOKENS_RE         ";|:=|:>|\\+\\+|--|\\*\\*|,|==|!=|:|\\[|\\]|\\(|\\)|\\{|\\}|<|>|\\#Program|Start|Stop|Integer_2|[_0-9A-Za-z]+|[^ \t\r\f\v\n]"
#define KEYWORDS_RE       ";|:>|\\+\\+|--|\\*\\*|,|==|!=|\\[|\\]|\\(|\\)|\\{|\\}|#Program|Data|Start|Stop|Read|Write|If|Else|For|Downto|Do|Div|Mod|<|>|!|And|Or|Integer_2"

#define IDENTIFIERS_RE    "_[0-9][A-Z][A-Z][0-9]"
